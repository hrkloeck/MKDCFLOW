...
```
condor_submit 09_MAKE_MULTIPLE_SPWD_FILE.sub DATA_FILE=1678454471_sdp_l0.ms DATA_PATH=/bEDD/MPLUS-WORKONDATA WORK_PATH=${PWD} SPWD=16 
```
...
```
chmod 755 11_DO_FULL_CALIBRATION
```


```
condor_submit 11_DO_FULL_CALIBRATION.sub DATA_FILE=1678454471_sdp_l0.ms DATA_PATH=/bEDD/MPLUS-WORKONDATA WORK_PATH=${PWD}
```
